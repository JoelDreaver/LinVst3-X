...
RemoteVSTServer::RemoteVSTServer(std::string fileIdentifiers,
    ...
    : RemotePluginServer(fileIdentifiers), m_name(fallbackName), m_maker(""),
      ...
      guiVisible(false), parfin(0), audfin(0), getfin(0), guiupdate(0),
...
#ifdef EMBED
#ifdef VST32SERVER
  cerr << "LinVst3-X version 3.6-32bit" << endl;
#else
  cerr << "LinVst3-X version 3.6-64bit" << endl;
#endif
#else
#ifdef VST32SERVER
  cerr << "LinVst3-X version 3.6st-32bit" << endl;
#else
  cerr << "LinVst3-X version 3.6st-64bit" << endl;
#endif
#endif
