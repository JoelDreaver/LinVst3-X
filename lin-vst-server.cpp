...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR cmdlinexxx, int cmdshow)
{
    ...
    #ifdef EMBED
    #ifdef VST32SERVER
    cout << "LinVst3-X version 1.7-32bit" << endl;
    #else
    cout << "LinVst3-X version 1.7-64bit" << endl;    
    #endif
    #else
    #ifdef VST32SERVER
    cout << "LinVst3-X version 1.7st-32bit" << endl;
    #else
    cout << "LinVst3-X version 1.7st-64bit" << endl;    
    #endif    
    #endif
