...
#ifdef EMBED
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.0.1-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.0.1-64bit" << endl;
#endif
#else
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.0.1st-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.0.1st-64bit" << endl;
#endif
#endif
