...
#ifdef EMBED
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.0-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.0-64bit" << endl;
#endif
#else
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.0st-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.0st-64bit" << endl;
#endif
#endif
