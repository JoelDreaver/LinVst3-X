...
#ifdef EMBED
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.5-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.5-64bit" << endl;
#endif
#else
#ifdef VST32SERVER
  cerr << "LinVst3-X version 4.5st-32bit" << endl;
#else
  cerr << "LinVst3-X version 4.5st-64bit" << endl;
#endif
#endif
