...
BUILD_FLAGS  = -std=c++14 -fPIC -O2 -DLVRT -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE -DDOUBLEP -DXECLOSE -DNEWTIME -DINOUTMEM -DCHUNKBUF $(CXX_FLAGS)
