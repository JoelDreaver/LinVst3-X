...
BUILD_FLAGS  = -std=c++14 -fPIC -O2 -DLVRT -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE -DDOUBLEP -DNEWTIME -DINOUTMEM -DCHUNKBUF -DXECLOSE $(CXX_FLAGS)
