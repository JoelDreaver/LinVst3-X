...
BUILD_FLAGS  = -std=c++14 -fPIC -O2 -DLVRT -DXECLOSE -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE -DDOUBLEP -DNEWTIME -DINOUTMEM -DCHUNKBUF -DEMBEDRESIZE $(CXX_FLAGS)
